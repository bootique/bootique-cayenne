...
import io.bootique.cayenne.ehcache.CayenneEhCacheModule;
import io.bootique.cayenne.ehcache.persistent.Table1;
import io.bootique.cayenne.ehcache.persistent.Table2;
...
public class CacheInvalidationIT {
    ...
    public static void beforeClass() {
        TEST_RUNTIME = TEST_FACTORY.app("-c", "classpath:bq1.yml")
                .autoLoadModules()
                .module(b -> CayenneEhCacheModule.contributeInvalidationHandler(b).addBinding().to(G1InvalidationHandler.class))
                .createRuntime();
