...
public class CayenneTester implements BQBeforeScopeCallback, BQBeforeMethodCallback {
    ...
    /**
     * Configures the Tester to manage a subset of entities out of a potentially very large number of entities in the model.
     *
    ...
    protected void configure(Binder binder) {
        CayenneModule.extend(binder).addFilter(commitCounter).addFilter(queryCounter);
