...
/**
 * Generates DB schema for a collection of DataNodes.
 *
 * @since 2.0
 */
// TODO: generate a subset of schema for the explicitly specified entities
public class SchemaGenerator {

    private DataDomain domain;

    public SchemaGenerator(DataDomain domain) {
        this.domain = domain;
    }

    public void createSchema(String nodeName, DataMap map) {
